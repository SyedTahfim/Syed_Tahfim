## Introduction
Data Scientist and Researcher with a PhD in __Management Science and Engineering__ and professional expertise in loan portfolio analysis, __credit scorecard development__, __portfolio outstanding__ and __non-performing-assets__ forecasting. Skilled in **data warehousing, EDA, and statistical and machine learning models**. Well-versed in developing end-to-end machine learning projects. Published multiple peer-reviewed articles, including **SCI/SSCI- and EI-indexed** research articles featuring __hybrid-model__ based solution for __imbalance__ datasets. Proficient in Python, R, SQL, and modern data analysis frameworks, with strong capabilities in predictive modeling and real-world financial applications. Dedicated to bridging the gap between people, business, and technology.
